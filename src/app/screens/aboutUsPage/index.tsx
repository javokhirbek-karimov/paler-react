  ...
  return (
    <div className="about-page">
      ...
      <Container maxWidth="lg" className="main-content">
        ...
        {/* Contact CTA */}
        <Paper className="contact-section" elevation={3}>
          <Typography variant="h3" className="contact-title">
            Visit Our Boutique
          </Typography>
          <Typography variant="h6" className="contact-subtitle">
            Experience our collection in person and let our experts guide you to
            your perfect timepiece.
          </Typography>
          <Box className="contact-info">
            <Typography variant="body1">
              123 Horological Avenue, Geneva, Switzerland
            </Typography>
            <Typography variant="body1">
